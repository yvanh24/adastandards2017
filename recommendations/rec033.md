...
Module |
------ |
Table 2.2: Final cysticfibrosisdiabetes  | 


#### Implementation:
IS: cysticfibrosis AND (Table 2.2: ID08) OR (Table 2.2: ID09) (Table 2.2: ID10) OR (Table 2.2: ID11) OR (Table 2.2: ID12) OR (Table 2.2: ID13) OR (Table 2.2: ID14) OR (Table 2.2: ID15) OR (Table 2.2: ID16) OR (Table 2.2: ID17)
